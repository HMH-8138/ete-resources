...
COURSES_DATA = {
    ...
    '1-2': {
        'courses': [
            ...
            {'name': 'EES 183', 'title': 'Fundamentals of Electrical Machines'},
            {'name': 'MATH 183', 'title': 'Differential Equations'},
            {'name': 'PHY 185', 'title': 'Engineering Physics'},
        ...
        'labs': [
            ...
            {'name': 'PHY 182', 'title': 'Engineering Physics Session'},
            {'name': 'CSE 182', 'title': 'Computer Programming Sessional'}
        ]
    },
    '2-1': {
        'courses': [
        ...
        'labs': [
            {'name': 'ETE 202', 'title': 'Electronics-I Sessional'},
    ...
    '2-2': {
        'courses': [
            ...
            {'name': 'ETE 207', 'title': 'Electromagnetic Fields & Waves'},
