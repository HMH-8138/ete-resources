...
const users = [
    { id: '2208006', name: 'Meherab Hossen', email: 'meherab@test.com', batch: '2022', password: 'test123', createdAt: new Date() }
];
const resources = [
    { id: 1, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '3', term: '1', courseCode: 'ETE 301', courseName: 'Semiconductor Physics & Devices', resourceType: 'books', fileTitle: 'Chapter 1 - Introduction', description: 'Introduction to semiconductor physics', file: { filename: 'file-1772059922351-323079017.pdf', originalName: 'chapter1.pdf', size: 1024000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-25') },
    { id: 2, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '3', term: '1', courseCode: 'ETE 303', courseName: 'Industrial Electronics', resourceType: 'notes', fileTitle: 'Lecture Notes - Chapter 1', description: 'Power electronics fundamentals', file: { filename: 'file-1772060429745-903487855.pdf', originalName: 'lecture1.pdf', size: 2048000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-25') },
    { id: 3, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '3', term: '1', courseCode: 'ETE 305', courseName: 'Digital Communication', resourceType: 'questions', fileTitle: 'Previous Year Questions', description: 'Midterm questions from 2023', file: { filename: 'file-1772096550302-180389119.pdf', originalName: 'questions.pdf', size: 512000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-26') },
    { id: 4, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '3', term: '2', courseCode: 'ETE 311', courseName: 'Information Theory and Coding', resourceType: 'books', fileTitle: 'Information Theory Basics', description: 'Entropy and coding theorems', file: { filename: 'file-1772097421628-140262355.pdf', originalName: 'info_theory.pdf', size: 1536000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-26') },
    { id: 5, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '4', term: '1', courseCode: 'ETE 401', courseName: 'Telecommunication Networks', resourceType: 'notes', fileTitle: 'Network Architecture', description: 'OSI model and protocols', file: { filename: 'file-1772120521482-310982258.pdf', originalName: 'network_notes.pdf', size: 2560000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-27') },
    { id: 6, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '4', term: '1', courseCode: 'ETE 403', courseName: 'VLSI Technology', resourceType: 'books', fileTitle: 'CMOS Design Fundamentals', description: 'MOS transistor theory', file: { filename: 'file-1772124870655-550061836.pdf', originalName: 'cmos_design.pdf', size: 3072000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-27') },
    { id: 7, userId: '2208006', userName: 'Meherab Hossen', batch: '2022', level: '4', term: '2', courseCode: 'ETE 411', courseName: 'Optical Fiber Communications', resourceType: 'questions', fileTitle: 'Fiber Optic Lab Exam', description: 'Previous lab exam questions', file: { filename: 'file-1772127881922-19325356.pdf', originalName: 'lab_exam.pdf', size: 768000, mimetype: 'application/pdf' }, status: 'approved', uploadedAt: new Date('2024-11-28') }
];
